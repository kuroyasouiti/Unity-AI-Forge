...
Unity-AI-Forgeは、AIとの協働でUnityゲームを鍛造する開発ツールキットです。Model Context Protocol統合とGameKitフレームワークにより、AIアシスタントがUnity Editorとリアルタイムで対話。**47ツール**を備え、Low-Level CRUD操作、Mid-Levelバッチツール、High-Level GameKit（UI + Logic + Systems）の3層構造で、シンプルなアセット操作から複雑なゲームシステム構築まで対応します。
...
| **GameKit** | 14 | UI Pillar (5) + Logic Pillar (7) + Systems (2) |
