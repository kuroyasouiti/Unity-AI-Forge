...
def audio_source_bundle_schema() -> dict[str, Any]:
    """Schema for the unity_audio_source_bundle MCP tool."""
    return schema_with_required(
        {
            "type": "object",
            "properties": {
...
def character_controller_bundle_schema() -> dict[str, Any]:
    """Schema for the unity_character_controller_bundle MCP tool."""
    return schema_with_required(
        {
            "type": "object",
            "properties": {
