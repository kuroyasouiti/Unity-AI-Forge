    ...
    return schema_with_required(
        {
            ...
            "properties": {
                ...
                "cellSizeX": {"type": "integer", "minimum": 1, "description": "Grid cell width in pixels."},
                "cellSizeY": {"type": "integer", "minimum": 1, "description": "Grid cell height in pixels."},
                "pivot": {
                    "type": "object",
                    "properties": {"x": {"type": "number"}, "y": {"type": "number"}},
    ...
    return schema_with_required(
        {
            ...
            "properties": {
                ...
                "smoothness": {"type": "number", "minimum": 0, "maximum": 1, "description": "Smoothness value (0-1)."},
    ...
    return schema_with_required(
        {
            ...
            "properties": {
                ...
                "intensity": {"type": "number", "minimum": 0, "description": "Light intensity."},
                "range": {"type": "number", "minimum": 0, "description": "Light range (for Point/Spot)."},
                "spotAngle": {"type": "number", "minimum": 1, "maximum": 179, "description": "Spot light angle."},
                "shadows": {
                    "type": "string",
                    "enum": ["none", "hard", "soft"],
    ...
    return schema_with_required(
        {
            ...
            "properties": {
                ...
                "startSize": {"type": "number", "minimum": 0, "description": "Start size."},
                "startLifetime": {"type": "number", "minimum": 0, "description": "Start lifetime."},
                "startSpeed": {"type": "number", "description": "Start speed."},
                "startColor": {"type": "string", "description": "Start color (hex format)."},
                "maxParticles": {"type": "integer", "minimum": 0, "description": "Maximum particles."},
                "emissionRate": {"type": "number", "minimum": 0, "description": "Emission rate over time."},
                "duration": {"type": "number", "minimum": 0, "description": "System duration."},
