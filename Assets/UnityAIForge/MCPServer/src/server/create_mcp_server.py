...
def create_mcp_server() -> Server:
    server = Server(
        ...
        instructions="\n".join(
            [
                "# Unity-AI-Forge MCP Server v2.4.0 - Quick Reference",
                ...
                "4. 適切なレイヤーのツールを選択（Low→詳細制御、Mid→バッチ、High→ゲームシステム）",
                ...
                "",
                "### Mid-Level Batch (10ツール) - バッチ操作とプリセット",
                "Transform, RectTransform, Physics, Camera, UI, Audio, Input, CharacterController, Tilemap, Sprite2D, Animation2D",
                "用途: 複数オブジェクト一括処理、プリセット適用、レイアウト調整、2Dスプライト/アニメーション管理",
                "",
                "### High-Level GameKit (6ツール) - ゲームシステム構築",
                "Actor, Manager, Interaction, UICommand, Machinations, SceneFlow",
                "用途: ゲームメカニクス、ターン制御、リソース経済、シーン遷移、インタラクション",
                "",
                "## 基本ワークフロー",
                ...
                "- レンダリングレイヤー追加: unity_projectSettings_crud(operation='write', category='tagsLayers', property='addRenderingLayer', value='...')",
                "",
                "### Build Settings",
                ...
                "",
                "### ツール選択ガイド:",
                "1. **ゲームシステム構築** → High-Level GameKit (Actor, Manager, Interaction, UICommand, Machinations, SceneFlow)",
                ...
                "",
                "**Mid-Level Batch (10):**",
                "unity_transform_batch, unity_rectTransform_batch, unity_physics_bundle, unity_camera_rig, unity_ui_foundation, unity_audio_source_bundle, unity_input_profile, unity_character_controller_bundle, unity_tilemap_bundle, unity_sprite2d_bundle, unity_animation2d_bundle",
                "",
                "**Low-Level CRUD (8):**",
                ...
                "",
                "---",
                "Unity-AI-Forge v2.4.0 - 26 Tools, 100+ Operations, 3-Layer Architecture + UI-First Design + Batch Processing + Machinations Economics + 2D Sprite/Animation + Physics2D + Sorting Layers",
            ]
        ),
    )
