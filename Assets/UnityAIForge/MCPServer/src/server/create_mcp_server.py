    ...
    server = Server(
        ...
        instructions="\n".join(
            [
                ...
                "",
                "### Mid-Level Batch (8ツール) - バッチ操作とプリセット",
                "Transform, RectTransform, Physics, Camera, UI, Audio, Input, CharacterController",
                "用途: 複数オブジェクト一括処理、プリセット適用、レイアウト調整",
                "",
                ...
                "",
                "**Mid-Level Batch (8):**",
                "unity_transform_batch, unity_rectTransform_batch, unity_physics_bundle, unity_camera_rig, unity_ui_foundation, unity_audio_source_bundle, unity_input_profile, unity_character_controller_bundle",
                "",
                "**Low-Level CRUD (8):**",
