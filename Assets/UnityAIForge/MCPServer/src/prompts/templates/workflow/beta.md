...
# クリップをスプライトから作成
unity_animation_bundle(operation='createClipFromSprites',
...
### アニメーション
- [ ] animation_bundle(createController) でControllerを作成した
- [ ] animation_bundle(createClipFromSprites) でクリップを作成した
- [ ] animation_bundle(setupAnimator) でGameObjectにセットアップした
...
**animation_bundle に create 操作はない**
...
| `unity_animation_bundle` | setupAnimator / createController / createClipFromSprites |
