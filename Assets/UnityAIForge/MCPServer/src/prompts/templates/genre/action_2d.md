...
Mid-Level ツール（physics_bundle, tilemap_bundle, animation_bundle）で基盤を構築する。
...
Assets/
  Scripts/
    ...
    UI/
      HUDBinding.cs          # 生成: unity_gamekit_ui (widgetType=binding)
  Data/
    Characters/
